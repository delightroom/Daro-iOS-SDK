...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/delightroom/daro-rtb-ios-admob-adapter.git", exact: "2.0.0"),
        .package(url: "https://github.com/delightroom/daro-rtb-ios-max-adapter.git", exact: "2.0.0"),
        .package(
    ...
    targets: [
        .binaryTarget(
            name: "Daro",
            url: "https://github.com/delightroom/daro-ios-sdk/releases/download/v2.0.0-rc.8/Daro.xcframework.zip",
            checksum: "e8d93e09e4bb3b3ef9791cac06b1ef89dd9ae20d3b2ad3feda716eb6f4eab39f"
        ),
        .binaryTarget(
            name: "DaroObjCBridge",
            url: "https://github.com/delightroom/daro-ios-sdk/releases/download/v2.0.0-rc.8/DaroObjCBridge.xcframework.zip",
            checksum: "1c57d53f882ea2db6139f24599f07b7ed46c38551e54e0e95dee6a5d1fd5ea00"
        ),
        ...
        .target(
            ...
            dependencies: [
                "Daro",
                .product(name: "DaroBidAdMobAdapter", package: "daro-rtb-ios-admob-adapter"),
                .product(name: "DaroBidMaxAdapter", package: "daro-rtb-ios-max-adapter"),
