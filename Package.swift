...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "Daro",
            url: "https://github.com/delightroom/daro-ios-sdk/releases/download/v2.0.0-rc.4/Daro.xcframework.zip",
            checksum: "d65f315c343880ee99d08b52bae9dd4784a75cf511cb49d30a3d3ff017b25927"
        ),
        .binaryTarget(
            name: "DaroObjCBridge",
            url: "https://github.com/delightroom/daro-ios-sdk/releases/download/v2.0.0-rc.4/DaroObjCBridge.xcframework.zip",
            checksum: "122342887898bfc339bf85e7e532f74892dd0970137b5f88964a0ffb923b67b8"
        ),
