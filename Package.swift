...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "Daro",
            url: "https://github.com/delightroom/daro-ios-sdk/releases/download/v2.0.0-rc.5/Daro.xcframework.zip",
            checksum: "6d0b0a0fe45b35ecbad1b0aa640219b0cf4047ace3a4e34fa4bbca1252b055a7"
        ),
        .binaryTarget(
            name: "DaroObjCBridge",
            url: "https://github.com/delightroom/daro-ios-sdk/releases/download/v2.0.0-rc.5/DaroObjCBridge.xcframework.zip",
            checksum: "02aeef3d9c2dfb4944fead38f7b09acc852eb98aea613b5b1927613bfa89170d"
        ),
